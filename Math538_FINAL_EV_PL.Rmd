...
hist_gg(diff_combined, diff_combined, title = "Difference of Original Data and Imputed Data for All 5 Imputed Data Sets", x_axis_label = "Difference")
```

$$\textbf{Figure X.}\text{ Histogram of the difference of the actual close price vs the imputated data points}  $$
Figure X shows the difference from the original score vs the imputated score for all 5 multiply imputed datasets combined into one visualiztion. As one can see, the vast majority of points had a very small difference between the actual and the imputated, showing that the imputation was a success. The appendix hosts histograms of differences for all 5 data sets individually.
...
```{r}
hist_gg(stocks, close_preamp - imp1, title = "Histogram of Difference of Original Data and Imputed Data (Imputed Data 1", x_axis_label = "Difference")

hist_gg(stocks, close_preamp - imp2, title = "Histogram of Difference of Original Data and Imputed Data (Imputed Data 2", x_axis_label = "Difference")

hist_gg(stocks, close_preamp - imp3, title = "Histogram of Difference of Original Data and Imputed Data (Imputed Data 3", x_axis_label = "Difference")

hist_gg(stocks, close_preamp - imp4, title = "Histogram of Difference of Original Data and Imputed Data (Imputed Data 4", x_axis_label = "Difference")
