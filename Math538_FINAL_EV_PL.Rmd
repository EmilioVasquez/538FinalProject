...
post_samples1 <- posterior_samples(fits[[1]], pars = c("Intercept", "lagged_close", "sigma"))
...
Add in interpretation for ha has

```{r,intercept_samples_efv, echo = FALSE, eval = FALSE}
# Histogram for the Intercept
#hist(post_samples$b_Intercept, breaks = 30, main = "Posterior of #Intercept", 
#     xlab = "Intercept", col = "blue")
