...
#ts_line(imputed, "date", "close", title = 'Data after PMM imputation method is run to fill in missing values')
...
hist_gg(post_samples, b_lagged_close, "Posterior of Lagged Return", 'Lagged Close')
```
